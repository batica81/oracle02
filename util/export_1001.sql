...
SET DEFINE OFF;
Insert into DB02.ARTIKAL_DETALJI (JEDMERE,OPISARTIKLA,SIFRAARTIKLA,TRENUTNA_CENA) values ('kom','Analogna kamera',5,280);
Insert into DB02.ARTIKAL_DETALJI (JEDMERE,OPISARTIKLA,SIFRAARTIKLA,TRENUTNA_CENA) values ('kom','Analogni DVR',6,450);
Insert into DB02.ARTIKAL_DETALJI (JEDMERE,OPISARTIKLA,SIFRAARTIKLA,TRENUTNA_CENA) values ('m','Opticki kabl',9,100);
REM INSERTING into DB02.CENA
SET DEFINE OFF;
Insert into DB02.CENA (DATUM,SIFRAARTIKLA,CENA,STOPAPDV,NAZIVARTIKLA) values (to_timestamp('10-JAN-17 09.48.23.477000000 PM','DD-MON-RR HH.MI.SSXFF AM'),9,100,18,'Kabl');
Insert into DB02.CENA (DATUM,SIFRAARTIKLA,CENA,STOPAPDV,NAZIVARTIKLA) values (to_timestamp('10-JAN-17 09.47.05.359000000 PM','DD-MON-RR HH.MI.SSXFF AM'),5,250,20,'Kamera');
Insert into DB02.CENA (DATUM,SIFRAARTIKLA,CENA,STOPAPDV,NAZIVARTIKLA) values (to_timestamp('10-JAN-17 09.47.21.437000000 PM','DD-MON-RR HH.MI.SSXFF AM'),6,450,20,'DVR');
Insert into DB02.CENA (DATUM,SIFRAARTIKLA,CENA,STOPAPDV,NAZIVARTIKLA) values (to_timestamp('10-JAN-17 09.55.13.117000000 PM','DD-MON-RR HH.MI.SSXFF AM'),5,280,20,'Kamera');
...
Insert into DB02.PONUDA (BRPONUDE,DATUM,SIFRAKUPCA,IMEKUPCA) values (5,to_timestamp('10-JAN-17 04.09.37.966000000 PM','DD-MON-RR HH.MI.SSXFF AM'),5,'Mile');
...
SET DEFINE OFF;
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (25,2,2,5);
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (26,2,2,5);
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (27,3,2,5);
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (21,1,2,5);
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (23,1,3,5);
Insert into DB02.STAVKAPONUDE (RBR,BRPONUDE,KOLICINA,SIFRAARTIKLA) values (28,3,2,5);
REM INSERTING into DB02.TABLE1
SET DEFINE OFF;
Insert into DB02.TABLE1 (COLUMN1) values (12);
Insert into DB02.TABLE1 (COLUMN1) values (11);
Insert into DB02.TABLE1 (COLUMN1) values (12);
Insert into DB02.TABLE1 (COLUMN1) values (12);
Insert into DB02.TABLE1 (COLUMN1) values (12);
Insert into DB02.TABLE1 (COLUMN1) values (12);
...
BEFORE INSERT or UPDATE of cena
on cena
FOR EACH row
